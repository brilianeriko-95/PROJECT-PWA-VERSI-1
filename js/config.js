...
const AREAS_CT = {
   ...
   "LOAD HOURS [LAPORAN][ALL]": ["LOAD HOURS C-6701 A",
                      "LOAD HOURS C-6701 B", 
                      "LOAD HOURS C-6702 A", 
                      "LOAD HOURS C-6702 B"],
   "TOTAL HOURS [LAPORAN][ALL]": ["TOTAL HOURS C-6701 A",
                      "TOTAL HOURS C-6701 B", 
                      "TOTAL HOURS C-6702 A", 
                      "TOTAL HOURS C-6702 B"],
   "TOTALIZER [LAPORAN][ALL]": ["RCW"],
