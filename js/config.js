...
const GAS_URL = "https://script.google.com/macros/s/AKfycbwL4XBhIdAmBLFYyTxypC0z0p8mKCQKfxJwrtsE699sp1XHh8Au9cml8l5OkDeP1m-T/exec";
...
const AREAS_CT = {
   ...
   "OLI GEARBOX SA [ALL][LAPORAN]": ["MT-6511 A (Cm)",
                      "MT-6511 B (Cm)", 
                      "MT-6511 C (Cm)", 
                      "MT-6511 D (Cm)"],
